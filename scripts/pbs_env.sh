#!/bin/bash
# Centralized environment configuration for PBS/RDS HPC
# Source this file in all PBS shell scripts: source scripts/pbs_env.sh
...
# Convenience vars for train/dev/test split (for consistency with slurm_env)
export TRAIN_DATA_DIR="${PROCESSED_DATA_DIR}/train"
export DEV_DATA_DIR="${PROCESSED_DATA_DIR}/dev"
export TEST_DATA_DIR="${PROCESSED_DATA_DIR}/test"
...
if [ "${VERBOSE_ENV}" = "1" ]; then
    echo "====== PBS Environment Configuration ======"
