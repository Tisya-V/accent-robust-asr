...
class PackedDatasetIterator:
    def __init__(self, filenames, n_chunks, block_size, seed, shuffle, wrap):
        ...
        # Note: Could optimize by using a single text stream
        #       with the sequence of all files to be fetched/loaded
        self._filenames = filenames
        self._file_idx = 0
    ...
    def _load_n_chunks(self):
        ...
        for i in range(self._n_chunks):
            ...
            # Note: Header consistency check could be added here
    ...
    def __next__(self):
        if self._curr_idx >= len(self._block_idxs):
            self._load_n_chunks()
            # Note: Could trigger prefetching for remote files here
