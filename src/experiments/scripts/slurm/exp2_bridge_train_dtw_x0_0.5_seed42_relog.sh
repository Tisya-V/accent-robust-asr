#!/bin/bash
#SBATCH --job-name=exp2_bridge_dtw_x0_relog
...
echo "=========================================="
echo "E2 Bridge — DTW-fixed alignment, x0, sigma_max=0.5, seed=42 (isolated relog)"
echo "Job:  ${SLURM_JOB_ID}"
echo "GPU:  $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null)"
echo "=========================================="

OUT_DIR=models/bridge_dtw_fixed_x0_0.5_seed42_relog
...
python -m src.experiments.exp2_latent_diffusion_bridge.train \
    ...
    --patience        8 \
    --ema_decay       0.99 \
    --notes           "isolated norm-tracking relog (x0), do not overwrite existing models" \
    --seed            42
