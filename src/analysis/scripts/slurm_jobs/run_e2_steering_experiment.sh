...
#SBATCH --job-name=e2_steering_experiment
#SBATCH --partition=a30
#SBATCH --time=3:00:00
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#SBATCH --output=logs/e2_steering_experiment.log
#SBATCH --error=logs/e2_steering_experiment.log
...
echo "=========================================="
echo "E2 Latent Steering Experiment (SLURM)"
echo "=========================================="
